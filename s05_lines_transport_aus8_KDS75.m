...
margs = [0.6 0.2 0.4 0.4]/screen_ratio; % cm
...
h_tit = title(['(' lett(sp) ...
    ') SBC local zonal and cumulative CC transports ($Sv$)'], ...
...
h_tit = title(['(' lett(sp-1) ...
    ') SBC cumulative transports with the FC ($Sv$)'], ...
    'fontsize',font_size, 'horizontalalignment','left');
h_tit.Position(1) = 115;
...
h_tit = title(['(' lett(sp-1) ...
    ') FC local zonal and cumulative horiz. and vert. transports ($Sv$)'], ...
    'fontsize',font_size, 'horizontalalignment','left');
h_tit.Position(1) = 115;

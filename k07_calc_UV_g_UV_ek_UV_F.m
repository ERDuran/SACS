...
% 
% % data sorting
% data{1} = KDau_U_g.mean;
% data{2} = KDau_V_g.mean;
% data{3} = KDau_U_ek.mean;
% data{4} = KDau_V_ek.mean;
% data{5} = KDau_U.mean;
% data{6} = KDau_V.mean;
% 
% titles{1} = ...
%     ['KDau mean HH $U_{g}$ $(m^2/s)$'];
% titles{2} = ...
%     ['KDau mean HH $V_{g}$ $(m^2/s)$'];
% titles{3} = ...
%     ['KDau mean $U_{ek}$ $(m^2/s)$'];
% titles{4} = ...
%     ['KDau mean $V_{ek}$ $(m^2/s)$'];
% titles{5} = ...
%     ['KDau mean $U$ $(m^2/s)$'];
% titles{6} = ...
%     ['KDau mean $V$ $(m^2/s)$'];

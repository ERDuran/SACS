...
U_prime_ztop_to_zmid_anom = U_prime_ztop_to_zmid - U_prime_ztop_to_zmid_K;
V_prime_ztop_to_zmid_interp2_anom = V_prime_ztop_to_zmid_interp2 - V_prime_ztop_to_zmid_interp2_K;

U_g_prime_zmid_to_zbot_anom = U_g_prime_zmid_to_zbot - U_g_prime_zmid_to_zbot_K;
V_g_prime_zmid_to_zbot_interp2_anom = V_g_prime_zmid_to_zbot_interp2 - V_g_prime_zmid_to_zbot_interp2_K;
...
%             'HorizontalAlignment','right','color', [0 0 0])
    ...
    if sp == rowN*colN
        rectangle('Position',[105 -51 47.75 41.5], ...
            ...
            'Clipping', 'off')
        text(106.5, -35.5, '\textbf{MOM01-75z model velocity}', 'Rotation',90,...
            'fontsize', font_size+2)
        rectangle('Position',[105 -9.0 47.75 39.25], ...
            'EdgeColor', [0 0 0], 'linewidth', 1, ...
            'Clipping', 'off')
        text(106.5, 0, '\textbf{MOM01-75z geostrophic and Ekman velocity}', 'Rotation',90,...
            'fontsize', font_size+2)
...
data = {U_prime_ztop_to_zmid_anom*magnif, U_g_prime_zmid_to_zbot_anom*magnif};
v_data = {V_prime_ztop_to_zmid_interp2_anom*magnif, ...
    V_g_prime_zmid_to_zbot_interp2_anom*magnif};
...
%             'HorizontalAlignment','right','color', [0 0 0])
    ...
    if sp == rowN*colN
        rectangle('Position',[105 -51 47.75 41.5], ...
            'EdgeColor', [0 0 0], 'linewidth', 1, ...
            'Clipping', 'off')
        text(106.5, -50.5, '\textbf{MOM01-75z geostrophic + Ekman velocity relative to model velocity}', 'Rotation',90,...

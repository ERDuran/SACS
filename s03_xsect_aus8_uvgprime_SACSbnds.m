...
for sp = 3
    subplot_x = marg_l+x_sp*(cm(1)-1)+gap_w*(cm(1)-1);
    subplot_y = marg_b+y_sp*(rm(1)-1)+gap_h*(rm(1)-1);
    ...
    if sp == 3
        arrow([-32.9 -500], ...
            ...
            aus8_currents.lon_u_ALLC==aus8_figures.cross.lon(1,sp)) ...
            -100], 4)
        text(-32.9, -500, '$SBCs\ N$', 'fontsize',font_size)
        arrow([-32.9 -700], ...
            [-33.5 ...
            aus8_currents.z_mid], 4)
        text(-32.9, -700, '$SBCs\ Btm$', 'fontsize',font_size)
        arrow([-32.9 -900], ...
            [aus8_currents.lat_v_SBC_south(...
            aus8_currents.lon_u_ALLC==aus8_figures.cross.lon(1,sp)) ...
            -100], 4)
        text(-32.9, -900, '$SBCs\ S$', 'fontsize',font_size)
        arrow([-33.5 -1150], ...
            [aus8_currents.lat_v_DRC_south(...
            aus8_currents.lon_u_ALLC==aus8_figures.cross.lon(1,sp)) ...
            -100], 4)
        text(-33.5, -1150, '$FC\ S\ up$', ...
            'fontsize',font_size)
        arrow([-33.5 -1400], ...
            [aus8_currents.lat_v_DRC_south(...
            aus8_currents.lon_u_ALLC==aus8_figures.cross.lon(1,sp)) ...
            -1000], 4)
        text(-33.5, -1400, '$FC\ S\ low$', ...
            'fontsize',font_size)
        arrow([-33.5 -1700], ...
            [-34.5 ...
            -2000], 4)
        text(-33.5, -1700, '$FC\ Btm$', ...
            'fontsize',font_size)
    end   
    ...
    if col_ind(1) ~= 1, set(gca,'yticklabel',''), end
    ...
    if sp == 3
        ...
        set(cbar,'units','centimeters','position', [...
            (marg_l+x_sp*(cm(1))+gap_w*(cm(1)-1)+plot_cbar_gap), ...
            (marg_b+y_sp*(rm(1)-1)+gap_h*(rm(1)-1)), ...
            cbar_x, ...
            cbar_y]);
        pointycbar(cbar)
